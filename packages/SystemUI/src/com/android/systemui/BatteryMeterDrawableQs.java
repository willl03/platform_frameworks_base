...
public class BatteryMeterDrawableQs extends Drawable implements
        BatteryController.BatteryStateChangeCallback {

    private static final float ASPECT_RATIO = 9.5f / 14.5f;
    public static final String TAG = BatteryMeterDrawableQs.class.getSimpleName();
    ...
    public BatteryMeterDrawableQs(Context context, Handler handler, int frameColor) {
        mContext = context;
        mHandler = handler;
